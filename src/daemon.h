...
/**
 * @brief structure for getting the UUID.
 *
 * Structure is used to get the UUID from the daemon and send back the UUID
 * in request format
 */
struct request_get_uuid
{
	struct request r;     /**< Daemon thread process the request r. */
